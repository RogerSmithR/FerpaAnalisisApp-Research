...
{
    public class HIPPA : Controller
    {
        private readonly ApplicationDbContext _context;
        private readonly IWebHostEnvironment _hostEnvironment;
        public HIPPA(ApplicationDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        {
            var ferpaID = _context.DocumentType.FirstOrDefault(x => x.Title == "HIPAA").DocumentTypeId;
